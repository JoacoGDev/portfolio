...
const Navbar = () => {
  ...
  {/* Barra superior */}
  <div className="bg-gray-100/90 dark:bg-[#111111]/90 backdrop-blur-sm rounded-full shadow-lg max-w-2xl w-full mx-4 mt-4 transition-colors duration-300 flex justify-between items-center h-12 px-4 sm:px-6">
    {/* Logo */}
  ...
  {/* Menú móvil separado */}
  {isOpen && (
    <div className="md:hidden flex flex-col gap-2 px-4 py-3 mt-2 rounded-lg bg-gray-100/90 dark:bg-[#111111]/90 shadow-lg max-w-2xl w-full mx-4">
      {navLinks.map((link) => (
        <a
          key={link.id}
          href={`#${link.id}`}
