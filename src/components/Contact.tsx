      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl sm:text-6xl lg:text-7xl font-bold font-mono bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-800 dark:from-blue-400 dark:via-indigo-400 dark:to-blue-300 bg-clip-text text-transparent mb-6 leading-tight">
            Hablemos
            <br />
            <span className="text-4xl sm:text-5xl lg:text-6xl font-light">de oportunidades</span>
          </h2>

          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
            Si estás buscando un desarrollador motivado y apasionado por la tecnología,
            me encantaría conversar. Contáctame y veamos cómo puedo sumarme a tu equipo o contribuir a tus proyectos.
          </p>
